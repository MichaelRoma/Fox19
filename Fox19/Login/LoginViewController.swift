...
class LoginViewController: UIViewController {
    ...
    private func alertMessage() {
        let alert = UIAlertController(title: "Нужно SigUp", message: "Нужно сделать SignUP", preferredStyle: .alert)
    ...
    @objc private func sendTapped() {
        ...
        guard let _ = Keychainmanager.shared.getToken(account: phone) else {
            alertMessage()
            return }
